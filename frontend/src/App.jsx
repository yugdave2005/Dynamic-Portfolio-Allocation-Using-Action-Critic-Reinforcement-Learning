      ...
      <div className="dashboard">
        ...
        <header className="header">
          ...
          <div className="header-right">
            <button className="export-btn" style={{ borderColor: COLORS.green2, color: COLORS.green2 }} onClick={() => {
              if (window.electronAPI) window.electronAPI.openRLOptimizer();
              else window.open('/dalal_live_rl.html', '_blank');
            }}>Launch Live RL Optimizer</button>
