...
{}.oninput = e => {}.innerText = ['Very Low', 'Low', 'Balanced', 'High', 'Very High'][e.target.value-1];
{}.oninput = e => {}.innerText = parseFloat(e.target.value).toFixed(2) + '%';
{}.oninput = e => {}.innerText = e.target.value;
{}.oninput = e => {}.innerText = parseFloat(e.target.value).toFixed(4);
{}.oninput = e => {}.innerText = parseFloat(e.target.value).toFixed(3);
...
function logText(msg, type='log-norm') {
  const d = new Date();
  ({}).innerHTML += `<div class="log-line ${type}">[${d.toLocaleTimeString()}] ${msg}</div>`;
  ({}).scrollTop = ({}).scrollHeight;
}

 }, scales: { x: { grid: { color: 'rgba(255,255,255,0.04)' } }, y: { grid: { color: 'rgba(255,255,255,0.04)' } } }, animation: { duration: 300 } };
